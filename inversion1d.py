...
def invert_1d(inversion_title):
    ...
    stations2invert = [inversion_title]
    ...
    peris = peris[(peris >= 0.002) & (peris <= 0.2)]
    ...
    print(f"Done station {inversion_title}")


inversion_titles = np.arange(1140, 1151)
print(f"Inverting {len(inversion_titles)} stations: {inversion_titles}")

for station in inversion_titles:
    invert_1d(station)